...
public class PatientIntakeDatabaseHelper extends SQLiteOpenHelper {
    ...
    static final String KEY_ID = "id", NAME = "name", ADDRESS = "address", BDAY = "birthday", PHONE = "phone", CARD = "card", DESCRIPTION = "description";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(
                "CREATE TABLE " + TABLE_NAME + " ( " + KEY_ID + " integer primary key autoincrement, "
                        + NAME + " text NOT NULL, " + ADDRESS + " text NOT NULL, " + BDAY + " date NOT NULL, " + PHONE + " text NOT NULL, " + CARD + " text NOT NULL, " + DESCRIPTION + " text NOT NULL, "
